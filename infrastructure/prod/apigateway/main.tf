#------------------------------------------------------------------------------
# Prod Environment API Gateway - Release Metadata API
#------------------------------------------------------------------------------

resource "aws_api_gateway_rest_api" "main" {
  name        = "${var.project_name}-${var.environment}-${var.api_name}"
  description = "Release Metadata API for ${var.environment} environment - PRODUCTION"
...
resource "aws_api_gateway_method" "health_get" {
  ...
  http_method   = "GET"
  authorization = "NONE" # Public health check is acceptable usually, or restrict if needed
}
